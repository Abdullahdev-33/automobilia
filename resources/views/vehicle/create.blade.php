<x-dashboard-layout>
    ...
    <div class="p-8" >
        ...
        <form action="{{ route('vehicle.store') }}" method="post" class="my-10  max-w-[750px] mx-auto " enctype="multipart/form-data">
            ...
            <div class="bg-zinc-800 h-[350px] rounded  relative " >
                ...
                <label for="imgUpload" class="absolute top-0 w-full h-full cursor-pointer z-10" >
                    <img id="previewImage" class="object-fit shadow w-full h-full object-center rounded-sm hover:opacity-[.5] transition " src="{{asset('blogbanner.png')}}" alt="Placeholder Image">
                </label>
